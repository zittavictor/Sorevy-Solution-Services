    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-white to-purple-50 p-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Sign up to get started with Sorevy</p>
        </div>
          ...
          <form className="space-y-4" action="/dashboard" method="GET">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="first-name" className="border-purple-200 focus-visible:ring-purple-500" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="last-name">Last name</Label>
                <Input id="last-name" className="border-purple-200 focus-visible:ring-purple-500" />
              </div>
            </div>
            <div className="space-y-2">
